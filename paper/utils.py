...
def train_model_matbench(Fork, mat_prop, i, classification=False, batch_size=None,
...
def train_model(Fork, model_name, mat_prop, classification=False, batch_size=None,
              transfer=None, verbose=True):
    # Get the TorchedCrabNet architecture loaded
    model = Model(Fork(compute_device=compute_device).to(compute_device),
...
if __name__ == '__main__':
    ...
    for mat_prop in mat_props:
        ...
        model = train_model(Fork,model_name, mat_prop, classification, verbose=True)
        print('=====================================================')
